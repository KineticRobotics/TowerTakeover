...
pros::Controller master2(pros::E_CONTROLLER_MASTER);
pros::Motor dr4b_left2(15);
pros::Motor dr4b_right2(16);
pros::Motor claw2(8, true);

pros::Motor rightFront2(10, true);
pros::Motor rightBack2(20, true);
pros::Motor leftFront2(1);
pros::Motor leftBack2(11);

//Below this line is okapi above is old motor stuff
okapi:: MotorGroup right2({11_rmtr, 20_rmtr});
okapi:: MotorGroup left2({1, 10});
...
const auto WHEEL_DIAMETER2 = 4.25_in;
const auto CHASSIS_WIDTH2 = 13.5_in;
...
auto PIDsimple2 = ChassisControllerFactory::create(left2, right2, AbstractMotor::gearset::green, {4.25_in, 13.5_in});
